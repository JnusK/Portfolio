import {travelImages} from "../img/travel-img";

export const TravelList = [
  {
    image: travelImages.peytoLake,
    location: 'Peyto Lake, Canada',
    link: '/travel/2017/canada',
    md: `Coming soon! Stay tuned!`
  },
  {
    image: travelImages.shifenWaterfall,
    location: 'Shifen, Taiwan',
    link: '/travel/2018/taiwan',
    md: `Coming soon! Stay tuned!`
  },
  {
    image: travelImages.lakeBled,
    location: 'Lake Bled, Slovenia',
    link: '/travel/2019/slovenia',
    travelDate: 'Jan 2019',
    md: `# Winter trip to Slovenia
...
In winter, the only boats on the lake are the electric ones, with the other boats all moored up on the shore. 

The only downside is Vintgar Gorge being closed during winter.

![Lake Bled](${travelImages.lakeBled})
...
![Waterfall Pericnik](${travelImages.waterfallPericnik})
